        ...
        if len(jukhajechl_yn) > 0:
            ...
            dict = (ata,mrn,gweight,gw_unit,ctns,ctns_unit,pum_name,
                   ...
                   iphng_banip_date,trans_banip_storage_cd,
                    ...
                    banchul_gihan,update_complete,impo_singo_date,banchul_delay_gihan,banchul_date,rmn_ctns,rmn_wht,tot_ctns,tot_wht,nowstat,delay_add_tax,spp_stat,key,area)
            return dict
        else:
            return ''
